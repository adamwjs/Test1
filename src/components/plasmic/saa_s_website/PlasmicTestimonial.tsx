...
import sty from "./PlasmicTestimonial.module.css"; // plasmic-import: aB-1YIIEaKFrO/css

import smalljpgNPxkYsXmPe9QcC from "./images/smalljpg.jpeg"; // plasmic-import: NPxkYSXmPE9QcC/picture
...
function PlasmicTestimonial__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.column__eD1L)}>
        <h2
        ...
        >
          <div className={classNames(projectcss.all, sty.column__xbYbQ)}>
            <p.PlasmicImg
          ...
          <div className={classNames(projectcss.all, sty.column__zPNky)}>
            <h5
