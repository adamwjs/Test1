...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: bXuR_ACR7JklZt/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: swvpcb63OmYRNC/render
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__sgFAy)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__erP9Z)}
              />
            </React.Fragment>
          ),
          value: args.children
